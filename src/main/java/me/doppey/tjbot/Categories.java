...
public abstract class Categories {
    ...
    public static final Command.Category Fun = new Command.Category("Fun");
    public static final Command.Category Games = new Command.Category("Games");
    public static final Command.Category Utility = new Command.Category("Utility");
